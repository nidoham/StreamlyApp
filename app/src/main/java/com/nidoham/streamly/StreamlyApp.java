 ...
 */
public class StreamlyApp extends Application {

    // Constants
    private static final String TAG = "StreamlyApp";
    ...
    private static volatile StreamlyApp instance;
    ...
    public void onCreate() {
        ...
        synchronized (StreamlyApp.class) {
            instance = this;
        ...
        if (DEBUG) Log.i(TAG, "Streamly Application created successfully");
    }
     ...
     * @return The StreamlyApp instance
     */
    public static StreamlyApp getInstance() {
        return instance;
    }
    ...
    public void onTerminate() {
        super.onTerminate();
        if (DEBUG) Log.i(TAG, "Streamly Application terminated");
